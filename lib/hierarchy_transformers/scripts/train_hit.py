...
def main(config_file: str):
    ...
    run = wandb.init(
        entity="jonathon-dilworth-university-of-manchester",
        project="HOPE",
        config=config
    )
    ...
    output_dir = f"experiments/HiT-{model_path_suffix}-{dataset_path_suffix}-{config.dataset_name}-{config.negative_type}"
