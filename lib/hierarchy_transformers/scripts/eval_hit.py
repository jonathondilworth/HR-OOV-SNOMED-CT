...
def main(config_file: str, output_path: str):
    ...
    # output_path: experiments/<MODEL_NAME>/eval
    ...
    pair_dataset = load_zenodo_dataset(f"{config.dataset_path}/{config.dataset_name}", lexicon, negative_type=f"{config.negative_type}", example_type="pair")
